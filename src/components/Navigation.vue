    ...
    <nav class="container">
      <div class="branding">
        <router-link class="header" :to="{ name: 'Home' }"
          >🍻 บันทึกไอเดียได้ทุกที่</router-link
        >
      </div>
      <div class="nav-links">
        <ul v-show="!mobile">
          <router-link class="link" :to="{ name: 'Home' }">หน้าแรก</router-link>
          <router-link class="link" :to="{ name: 'Blogs' }">บทความ</router-link>
          <router-link v-if="user" class="link" :to="{ name: 'CreatePost' }"
            >สร้างโพสต์</router-link
          >
